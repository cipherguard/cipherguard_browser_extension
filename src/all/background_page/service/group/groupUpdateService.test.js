...
import {defaultGroupUser} from "cipherguard-styleguide/src/shared/models/entity/groupUser/groupUserEntity.test.data";
import {defaultResourcesSecretsDtos} from "../../model/entity/secret/groupUpdate/groupUpdateSecretsCollection.test.data";
import {defaultSecretDto} from "cipherguard-styleguide/src/react-extension/components/Resource/CreateResource/CreateResource.test.data";
...
describe("GroupUpdateService", () => {
  ...
  it("should update the group and encrypt secrets for the new users", async() => {
    ...
    await service.exec(updateGroupEntity, "ada@cipherguard.com");
