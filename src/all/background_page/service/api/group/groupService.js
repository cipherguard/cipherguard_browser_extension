...
class GroupService extends AbstractService {
  ...
  /**
   * Create a group using Cipherguard API
   *
   * @param {Object} data
   * @returns {Promise<*>} Response body
   * @public
  ...
  /**
   * Update a group using Cipherguard API
   *
  ...
  /**
   * Simulate a group update using Cipherguard API
   *
   * @param {String} groupId uuid
   * @param {Object} groupData
   * @returns {Promise<*>} Response body
  ...
  /**
   * Delete a group using Cipherguard API
   *
   * @param {string} groupId uuid
