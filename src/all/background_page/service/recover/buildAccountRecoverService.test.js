...
describe("BuildAccountRecoverService", () => {
  describe("BuildAccountRecoverService:buildFromUrl", () => {
    ...
    it("should not build if url cannot be parsed.", () => {
      const url = "https://cipherguard.dev/setup/recover/start";
      expect.assertions(1);
      expect(() => BuildAccountRecoverService.buildFromRecoverUrl(url)).toThrowError();
    });

    it("should build.", () => {
      const url = "https://cipherguard.dev/setup/recover/start/571bec7e-6cce-451d-b53a-f8c93e147228/5ea0fc9c-b180-4873-8e00-9457862e43e0";
      expect.assertions(5);
      ...
      expect(account.domain).toBe("https://cipherguard.dev");
