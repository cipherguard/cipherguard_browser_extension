...
describe("BuildAccountSetupService", () => {
  describe("BuildAccountSetupService:buildFromUrl", () => {
    ...
    it("should not build if url cannot be parsed.", () => {
      const url = "https://cipherguard.dev/setup/start";
      expect.assertions(1);
      expect(() => BuildAccountSetupService.buildFromSetupUrl(url)).toThrowError();
    });

    it("should build.", () => {
      const url = "https://cipherguard.dev/setup/start/571bec7e-6cce-451d-b53a-f8c93e147228/5ea0fc9c-b180-4873-8e00-9457862e43e0";
      expect.assertions(5);
      ...
      expect(accountSetup.domain).toBe("https://cipherguard.dev");
