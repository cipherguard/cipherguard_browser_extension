...
import {defaultAccountRecoveryPrivateKeyPasswordDto} from "cipherguard-styleguide/src/shared/models/entity/accountRecovery/accountRecoveryPrivateKeyPasswordEntity.test.data";
...
describe("DecryptPrivateKeyPasswordDataService", () => {
  describe("DecryptPrivateKeyPasswordDataService:decrypt", () => {
    const expectedDomain = "https://cipherguard.local";
