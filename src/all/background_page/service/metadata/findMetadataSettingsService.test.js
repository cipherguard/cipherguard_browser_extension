...
} from "cipherguard-styleguide/src/shared/models/entity/metadata/metadataTypesSettingsEntity.test.data";
...
describe("FindMetadataSettingsService", () => {
  ...
  describe("::findTypesSettings", () => {
    ...
    it("marshall the API data with local default", async() => {
      ...
      expect(entity).toBeInstanceOf(MetadataTypesSettingsEntity);
      // The value of the default are expected to evolve with cipherguard transitioning to v5 types.
