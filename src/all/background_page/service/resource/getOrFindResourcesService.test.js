...
import {resourceAllTypesDtosCollection} from "cipherguard-styleguide/src/shared/models/entity/resource/resourcesCollection.test.data";
import {defaultResourceDto} from "cipherguard-styleguide/src/shared/models/entity/resource/resourceEntity.test.data";
import {defaultResourceMetadataDto} from "cipherguard-styleguide/src/shared/models/entity/resourceMetadata/resourceMetadataEntity.test.data";
...
describe("GetOrFindResourcesService", () => {
  ...
  describe("::getOrFindSuggested", () => {
    ...
    it("should filter the collection by supported resource types and filter by suggested url", async() => {
      ...
      const resources = await service.getOrFindSuggested("https://www.cipherguard.com");
    ...
    it("should not return any resources if no suggestions are found.", async() => {
      ...
      const resources = await service.getOrFindSuggested("https://www.not-cipherguard.com");
