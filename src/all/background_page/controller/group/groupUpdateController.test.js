...
const {users} = require("cipherguard-styleguide/src/shared/models/entity/user/userEntity.test.data");

const {updateGroupNameDto, add2UsersToGroupDto, add2UsersToGroupDryRunResponse} = require("./groupUpdateController.test.data");
const {defaultGroupDto} = require("cipherguard-styleguide/src/shared/models/entity/group/groupEntity.test.data");
