...
} from "cipherguard-styleguide/src/shared/models/entity/accountRecovery/accountRecoveryPrivateKeyPasswordEntity.test.data";
...
describe("AccountRecoverySaveOrganizationPolicyController", () => {
  ...
  describe("AccountRecoverySaveOrganizationPolicyController::exec", () => {
    ...
    it("Should rotate an account recovery organization key.", async() => {
      ...
      expect(privateKeyPasswordDecryptedData1.domain).toEqual("https://cipherguard.local");
      ...
      expect(privateKeyPasswordDecryptedData2.domain).toEqual("https://cipherguard.local");
