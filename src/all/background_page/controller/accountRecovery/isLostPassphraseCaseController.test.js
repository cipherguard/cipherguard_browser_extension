...
describe("IsLostPassphraseCaseController", () => {
  describe("IsLostPassphraseCaseController::exec", () => {
    it("Should return false if no case given in url parameter.", async() => {
      const mockedWorker = {
        tab: {
          url: "https://www.cipherguard.test/setup/recover/8c55bdd1-faca-4324-b58b-8f19de62d46e/c57b7cb1-18ab-4224-bf06-4aa3217dffd8"
        }
      };
    ...
    it("Should return false if it's not a 'lost-passphrase' case.", async() => {
      const mockedWorker = {
        tab: {
          url: "https://www.cipherguard.test/setup/recover/8c55bdd1-faca-4324-b58b-8f19de62d46e/c57b7cb1-18ab-4224-bf06-4aa3217dffd8?case=bidule"
        }
      };
      const controller = new IsLostPassphraseCaseController(mockedWorker);
      const check = await controller.exec();
    ...
    it("Should return true if it's a 'lost-passphrase' case.", async() => {
      const mockedWorker = {
        tab: {
          url: "https://www.cipherguard.test/setup/recover/8c55bdd1-faca-4324-b58b-8f19de62d46e/c57b7cb1-18ab-4224-bf06-4aa3217dffd8?case=lost-passphrase"
        }
      };
      const controller = new IsLostPassphraseCaseController(mockedWorker);
      const check = await controller.exec();
