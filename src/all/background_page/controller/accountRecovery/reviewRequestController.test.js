...
} from "cipherguard-styleguide/src/shared/models/entity/accountRecovery/accountRecoveryRequestEntity.test.data";
  ...
  describe("ReviewRequestController::exec", () => {
    ...
    each([
      ...
      it(`Should save a review account recovery request if approved: ${test.scenario}.`, async() => {
        ...
        expect(privateKeyPasswordDecryptedData.domain).toEqual("https://cipherguard.local");
