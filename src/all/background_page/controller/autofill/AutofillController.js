...
class AutofillController {
  ...
  fillCredential(webIntegrationWorker, credential) {
    ...
    if (this.isInformMenuWorker) {
      webIntegrationWorker.port.emit('cipherguard.web-integration.fill-credentials', credential);
      ...
      webIntegrationWorker.port.request('cipherguard.quickaccess.fill-form', credential.username, credential.password, url);
    }
  }
}
