...
const scenarios = [
  {url: "https://cipherguard.test/auth/login", expectedResult: false},
  {url: "https://cipherguard.test/auth/login/", expectedResult: false},
  {url: "https://cipherguard.test/auth/login?case=else", expectedResult: false},
  {url: "https://cipherguard.test/auth/login/?case=else", expectedResult: false},
  {url: "https://cipherguard.test/auth/login?case=sso-login-error", expectedResult: true},
  {url: "https://cipherguard.test/auth/login/?case=sso-login-error", expectedResult: true},
];
