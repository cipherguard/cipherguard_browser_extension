...
import {RESOURCE_TYPE_PASSWORD_DESCRIPTION_TOTP_SLUG, RESOURCE_TYPE_V5_DEFAULT_TOTP_SLUG} from "cipherguard-styleguide/src/shared/models/entity/resourceType/resourceTypeSchemasDefinition";
...
describe("ExportResourcesFileController", () => {
  ...
  describe("::exec", () => {
    ...
    const filename = `cipherguard-export-${date}.csv`;
