...
const parseSuggestedUrl = function(suggestedUrl) {
   ...
   * www.cipherguard.com:443, then the port information is deleted after the parsing.
   */
 ...
 *
 * By instance for a given hostname: accounts.cipherguard.com
 * The following hostnames should match:
 * - accounts.cipherguard.com
 * - cipherguard.com
 *
 * The following hostnames should not match:
 * - cipherguard.com.attacker.com
 * - attacker-cipherguard.com
 *
...
const isParentHostname = function(parent, child) {
  ...
  if (lastIndexOf !== -1) {
     ...
     * It will prevent an attacker to use a hostname such as www.cipherguard.com.attacker.com, and make cipherguard
     * recognize it as cipherguard.com.
     */
    if (lastIndexOf + parent.length === child.length) {
       ...
       * It will prevent an attacker to use a hostname such as www.attacher-cipherguard.com, and make cipherguard
       * recognize it as cipherguard.com.
       */
