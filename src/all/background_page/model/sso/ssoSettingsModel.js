...
class SsoSettingsModel {
  ...
  /**
   * Return the sso settings for a given id using Cipherguard API.
   *
  ...
  /**
   * Find the current active SSO settings using Cipherguard API
  ...
  /**
   * Activates an SSO settings matching a given id using Cipherguard API
   *
  ...
  /**
   * Deletes an SSO settings matching a given id using Cipherguard API
   *
   * @param {uuid} ssoSettingsId
