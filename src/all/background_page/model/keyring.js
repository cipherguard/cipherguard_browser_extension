...
const STORAGE_KEY_PUBLIC = 'cipherguard-public-gpgkeys';
const STORAGE_KEY_PRIVATE = 'cipherguard-private-gpgkeys';

/**
 * The class that deals with Cipherguard Keyring.
 */
class Keyring {
  /*
   * ==================================================
   ...
   */
  /**
   * Sync the local keyring with the cipherguard API.
  ...
  async sync() {
    ...
    // Get the updated public keys from cipherguard.
