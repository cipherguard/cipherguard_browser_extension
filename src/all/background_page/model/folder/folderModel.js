...
class FolderModel {
   ...
   */
  /**
   * Create a folder using Cipherguard API and add result to local storage
   *
   * @param {FolderEntity} folderEntity
   * @returns {Promise<FolderEntity>}
   */
  ...
  /**
   * Move a folder using Cipherguard API
   *
  ...
  /**
   * Update a folder using Cipherguard API
   *
   * @param {FolderEntity} folderEntity
   * @returns {Promise<FolderEntity>}
   */
  ...
  /**
   * Delete a folder using Cipherguard API
   *
   * @param {string} folderId uuid
