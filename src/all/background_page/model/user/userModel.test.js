...
import RoleEntity from "cipherguard-styleguide/src/shared/models/entity/role/roleEntity";
...
import CollectionValidationError from "cipherguard-styleguide/src/shared/models/entity/abstract/collectionValidationError";
...
describe("UserModel", () => {
  describe("UserModel::updateLocalStorage", () => {
    it("should request the API and store the retrieved data in the local storage", async() => {
      ...
      const dto1 = defaultUserDto({username: "ada@cipherguard.com"}, dtoOptions);
      const dto2 = defaultUserDto({username: "betty@cipherguard.com"}, dtoOptions);
      const dto3 = defaultUserDto({username: "carole@cipherguard.com"}, dtoOptions);
    ...
    it("should ignore invalid users or invalid associated groups users if any", async() => {
      ...
      // Duplicated user id;
      const dto3 = defaultUserDto({id: dto2.id, username: "carole@cipherguard.com"}, dtoOptions);
      const dto4 = defaultUserDto({username: "dame@cipherguard.com"}, dtoOptions);
  ...
  describe("UserModel::findAll", () => {
    it("should throw an error if users or its associated content do not validated.", async() => {
      ...
      const dto1 = defaultUserDto({username: "ada@cipherguard.com"}, dtoOptions);
      const dto2 = defaultUserDto({id: dto1.id, username: "carole@cipherguard.com"}, dtoOptions);
