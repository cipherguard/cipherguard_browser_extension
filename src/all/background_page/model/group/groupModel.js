...
class GroupModel {
  ...
  /**
   * Create a group using Cipherguard API and add result to local storage
   *
  ...
  /**
   * Simulate update a group using Cipherguard API
   *
  ...
  /**
   * Update a group using Cipherguard API and add result to local storage
   *
   * @param {GroupUpdateEntity} groupUpdateEntity
   * @param {boolean?} [ignoreInvalidEntity] Should invalid entities be ignored.
   * @returns {Promise<GroupEntity>}
