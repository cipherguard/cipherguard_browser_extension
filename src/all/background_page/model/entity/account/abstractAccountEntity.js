...
const UUID_CIPHERGUARD_NAMESPACE = 'd5447ca1-950f-459d-8b20-86ddfdd0f922';
...
class AbstractAccountEntity extends Entity {
  ...
  get id() {
    ...
    return uuidv5(`${this.domain}${this.userId}`, UUID_CIPHERGUARD_NAMESPACE);
  }
  ...
  /**
   * Get the domain
   * @returns {string} ref ie. http://cloud.cipherguard.com/acme
   */
  get domain() {
