 ...
 * @since         3.6.0
 */
import EntityCollection from "cipherguard-styleguide/src/shared/models/entity/abstract/entityCollection";
...
import EntityCollectionError from "cipherguard-styleguide/src/shared/models/entity/abstract/entityCollectionError";
...
class AccountRecoveryResponsesCollection extends EntityCollection {
   ...
   */
  constructor(AccountRecoveryResponsesCollectionDto, options = {}) {
