...
import {RESOURCE_TYPE_PASSWORD_AND_DESCRIPTION_SLUG, RESOURCE_TYPE_PASSWORD_DESCRIPTION_TOTP_SLUG, RESOURCE_TYPE_V5_DEFAULT_SLUG, RESOURCE_TYPE_V5_DEFAULT_TOTP_SLUG} from "cipherguard-styleguide/src/shared/models/entity/resourceType/resourceTypeSchemasDefinition";
...
describe("CsvKdbxRowParser", () => {
  ...
  it("parses resource of type password-description-totp with all properties from csv row", () => {
    ...
    const data = {
      ...
      "Password": "Secret 1",
      "Notes": "Description 1",
      "TOTP": "otpauth://totp/test.com%20%3A%20admin%40cipherguard.com:admin%40cipherguard.com?secret=TJSNMLGTCYOEMXZG&period=30&digits=6&issuer=test.com%20%3A%20admin%40cipherguard.com",
      "Group": "Folder 1"
    };
  ...
  it("parses resource from csv raise an error if totp entity is not valid", () => {
    ...
    const data = {
      ...
      "Password": "Secret 1",
      "Notes": "Description 1",
      "TOTP": "otpauth://totp/test.com%20%3A%20admin%40cipherguard.com:admin%40cipherguard.com?secret=TJSNMLGTCYOEMXZG&period=30&digits=10&issuer=test.com%20%3A%20admin%40cipherguard.com",
      "Group": "Folder 1"
    };
    try {
