 ...
 */
import CsvDashlaneRowParser from "../../../import/resources/csvRowParser/csvDashlaneRowParser";
import AbstractRowComposer from "./abstractRowComposer";

const FORMAT = "csv-dashlane";

class CsvDashlaneRowComposer extends AbstractRowComposer {
  /**
   ...
   */
  static get mapping() {
    return CsvDashlaneRowParser.mapping;
  }
...
export default CsvDashlaneRowComposer;
