 ...
 */
import CsvBitWardenRowParser from "../../../import/resources/csvRowParser/csvBitWardenRowParser";
import AbstractRowComposer from "./abstractRowComposer";

const FORMAT = "csv-bitwarden";

class CsvBitWardenRowComposer extends AbstractRowComposer {
  /**
   ...
   * Key values object where key represents the cipherguard entity property name and the value represents the CSV property name.
   * @returns {object}
   */
  static get mapping() {
    return CsvBitWardenRowParser.mapping;
  }
...
export default CsvBitWardenRowComposer;
