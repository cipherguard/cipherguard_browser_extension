...
import CsvNordpassRowComoposer from "./csvNordpassRowComposer";

describe("CsvNorpassRowComposer", () => {
  it("can compose nordpass csv row", () => {
    const dto = {
      "name": "Password 1",
      "username": "Username 1",
      "uri": "https://url1.com",
    ...
    const csvRow = CsvNordpassRowComoposer.compose(externalResourceEntity);
