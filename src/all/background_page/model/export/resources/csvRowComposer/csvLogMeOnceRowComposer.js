 ...
 */
import CsvLogMeOnceRowParser from "../../../import/resources/csvRowParser/csvLogMeOnceRowParser";
import AbstractRowComposer from "./abstractRowComposer";

const FORMAT = "csv-logmeonce";

class CsvLogMeOnceRowComposer extends AbstractRowComposer {
  /**
   ...
   */
  static get mapping() {
    return CsvLogMeOnceRowParser.mapping;
  }
...
export default CsvLogMeOnceRowComposer;
