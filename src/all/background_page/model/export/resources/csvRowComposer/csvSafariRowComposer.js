 ...
 */
import CsvSafariRowParser from "../../../import/resources/csvRowParser/csvSafariRowParser";
import AbstractRowComposer from "./abstractRowComposer";

const FORMAT = "csv-safari";

class CsvSafariRowComposer extends AbstractRowComposer {
  /**
   ...
   */
  static get mapping() {
    return CsvSafariRowParser.mapping;
  }
...
export default CsvSafariRowComposer;
