...
import {defaultPasswordExpirySettingsDto, defaultPasswordExpirySettingsDtoFromApi} from "cipherguard-styleguide/src/shared/models/entity/passwordExpiry/passwordExpirySettingsEntity.test.data";
import PasswordExpirySettingsEntity from "cipherguard-styleguide/src/shared/models/entity/passwordExpiry/passwordExpirySettingsEntity";
import PasswordExpirySettingsModel from "./passwordExpirySettingsModel";
import {v4 as uuid} from "uuid";
import CipherguardBadResponseError from "cipherguard-styleguide/src/shared/lib/Error/CipherguardBadResponseError";
import PasswordExpiryProSettingsEntity from "cipherguard-styleguide/src/shared/models/entity/passwordExpiryPro/passwordExpiryProSettingsEntity";
  ...
  describe('::delete', () => {
    ...
    it("should throw an Error if something goes wrong on the API", async() => {
      ...
      try {
        ...
        expect(e).toBeInstanceOf(CipherguardBadResponseError);
      }
    });
