...
describe("RecoverBootstrap", () => {
    ...
    it("Should attach events", async() => {
      ...
      const port = {
        ...
        _port: {
          sender: {
            tab: {
              url: "https://cipherguard.dev/setup/recover/571bec7e-6cce-451d-b53a-f8c93e147228/5ea0fc9c-b180-4873-8e00-9457862e43e0"
            }
          }
        }
      };
  ...
  describe("RecoverBootstrap::canBeAttachedTo", () => {
    each([
      {scenario: "Legacy url & top frame", url: "https://cipherguard.dev/setup/recover/571bec7e-6cce-451d-b53a-f8c93e147228/5ea0fc9c-b180-4873-8e00-9457862e43e0", frameId: Pagemod.TOP_FRAME_ID},
      {scenario: "Valid url & top frame", url: "https://cipherguard.dev/setup/recover/start/571bec7e-6cce-451d-b53a-f8c93e147228/5ea0fc9c-b180-4873-8e00-9457862e43e0", frameId: Pagemod.TOP_FRAME_ID},
    ...
    each([
      ...
      {scenario: "No token", url: "https://cipherguard.dev/setup/recover/start/571bec7e-6cce-451d-b53a-f8c93e147228", frameId: Pagemod.TOP_FRAME_ID},
      {scenario: "Not top frame", url: "https://cipherguard.dev/setup/recover/start/571bec7e-6cce-451d-b53a-f8c93e147228/5ea0fc9c-b180-4873-8e00-9457862e43e0", frameId: 1},
