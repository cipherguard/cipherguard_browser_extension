...
describe("PagemodManager", () => {
  ...
  describe("PagemodManager::exec", () => {
    it("Should find the recover page mod and inject file", async() => {
      ...
      const details = {
        tabId: 1,
        frameId: 0,
        url: "https://cipherguard.dev/setup/recover/d57c10f5-639d-5160-9c81-8a0c6c4ec856/efc85bca-fc9f-4b32-aebf-b82765312e47"
      };
      // process
    ...
    it("Should find the setup page mod and inject file", async() => {
      ...
      const details = {
        tabId: 1,
        frameId: 0,
        url: "https://cipherguard.dev/setup/start/d57c10f5-639d-5160-9c81-8a0c6c4ec856/efc85bca-fc9f-4b32-aebf-b82765312e47"
      };
      // process
      await PagemodManager.exec(details);
      // expectations
  ...
  describe("PagemodManager::hasPagemodMatchUrlToReload", () => {
    it("Should refresh tab if pagemod must refresh tab url", async() => {
      ...
      jest.spyOn(UserSettings.prototype, "getDomain").mockImplementation(() => "https://cipherguard.dev");
      // expectations
      expect(await PagemodManager.hasPagemodMatchUrlToReload("https://cipherguard.dev")).toBeTruthy();
      expect(await PagemodManager.hasPagemodMatchUrlToReload("https://www.cipherguard.com")).toBeFalsy();
      expect(await PagemodManager.hasPagemodMatchUrlToReload("https://cipherguard.dev/setup/recover/d57c10f5-639d-5160-9c81-8a0c6c4ec856/efc85bca-fc9f-4b32-aebf-b82765312e47")).toBeTruthy();
      expect(await PagemodManager.hasPagemodMatchUrlToReload("https://cipherguard.dev/auth/login")).toBeTruthy();
      expect(await PagemodManager.hasPagemodMatchUrlToReload("https://cipherguard.dev/setup/start/d57c10f5-639d-5160-9c81-8a0c6c4ec856/efc85bca-fc9f-4b32-aebf-b82765312e47")).toBeTruthy();
      expect(await PagemodManager.hasPagemodMatchUrlToReload("https://cipherguard.dev/account-recovery/continue/d57c10f5-639d-5160-9c81-8a0c6c4ec856/cb66b7ca-bb85-4088-b0da-c50f6f0c2a13")).toBeTruthy();
