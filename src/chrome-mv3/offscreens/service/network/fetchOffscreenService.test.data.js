...
export const defaultFetchMessage = message => ({
  ...
  data: {
    ...
    resource: "https://www.cipherguard.test/settings.json?api-version=v2",
    options: {
      credentials: "include",
...
export const defaultFetchResponse = () => (new Response(
  "{\n    \"header\": {\n        \"id\": \"0682ab8f-ecba-4336-a628-8b6cac609f49\",\n        \"status\": \"success\",\n        \"servertime\": 1713863028,\n        \"action\": \"bef9f3ca-86ef-5c6a-9b38-320e03ceb5df\",\n        \"message\": \"The operation was successful.\",\n        \"url\": \"\\/settings.json?api-version=v2\",\n        \"code\": 200\n    },\n    \"body\": {\n        \"app\": {\n            \"url\": \"https:\\/\\/www.cipherguard.test\\/\",\n            \"locale\": \"en-UK\"\n        },\n        \"cipherguard\": {\n            \"legal\": {\n                \"privacy_policy\": {\n                    \"url\": \"\"\n                },\n                \"terms\": {\n                    \"url\": \"https:\\/\\/www.cipherguard.com\\/terms\"\n                }\n            },\n            \"edition\": \"pro\",\n            \"plugins\": {\n                \"jwtAuthentication\": {\n                    \"enabled\": true\n                },\n                \"accountRecoveryRequestHelp\": {\n                    \"enabled\": true\n                },\n                \"accountRecovery\": {\n                    \"enabled\": true\n                },\n                \"selfRegistration\": {\n                    \"enabled\": true\n                },\n                \"sso\": {\n                    \"enabled\": true\n                },\n                \"mfaPolicies\": {\n                    \"enabled\": true\n                },\n                \"ssoRecover\": {\n                    \"enabled\": true\n                },\n                \"userPassphrasePolicies\": {\n                    \"enabled\": true\n                },\n                \"inFormIntegration\": {\n                    \"enabled\": true\n                },\n                \"locale\": {\n                    \"options\": [\n                        {\n                            \"locale\": \"de-DE\",\n                            \"label\": \"Deutsch\"\n                        },\n                        {\n                            \"locale\": \"en-UK\",\n                            \"label\": \"English\"\n                        },\n                        {\n                            \"locale\": \"es-ES\",\n                            \"label\": \"Espa\\u00f1ol\"\n                        },\n                        {\n                            \"locale\": \"fr-FR\",\n                            \"label\": \"Fran\\u00e7ais\"\n                        },\n                        {\n                            \"locale\": \"it-IT\",\n                            \"label\": \"Italiano (beta)\"\n                        },\n                        {\n                            \"locale\": \"ja-JP\",\n                            \"label\": \"\\u65e5\\u672c\\u8a9e\"\n                        },\n                        {\n                            \"locale\": \"ko-KR\",\n                            \"label\": \"\\ud55c\\uad6d\\uc5b4 (beta)\"\n                        },\n                        {\n                            \"locale\": \"lt-LT\",\n                            \"label\": \"Lietuvi\\u0173\"\n                        },\n                        {\n                            \"locale\": \"nl-NL\",\n                            \"label\": \"Nederlands\"\n                        },\n                        {\n                            \"locale\": \"pl-PL\",\n                            \"label\": \"Polski\"\n                        },\n                        {\n                            \"locale\": \"pt-BR\",\n                            \"label\": \"Portugu\\u00eas Brasil (beta)\"\n                        },\n                        {\n                            \"locale\": \"ro-RO\",\n                            \"label\": \"Rom\\u00e2n\\u0103 (beta)\"\n                        },\n                        {\n                            \"locale\": \"ru-RU\",\n                            \"label\": \"P\\u0443\\u0441\\u0441\\u043a\\u0438\\u0439 (beta)\"\n                        },\n                        {\n                            \"locale\": \"sv-SE\",\n                            \"label\": \"Svenska\"\n                        }\n                    ]\n                },\n                \"rememberMe\": {\n                    \"options\": {\n                        \"300\": \"5 minutes\",\n                        \"900\": \"15 minutes\",\n                        \"1800\": \"30 minutes\",\n                        \"3600\": \"1 hour\",\n                        \"-1\": \"until I log out\"\n                    }\n                }\n            }\n        }\n    }\n}",
  {
    ...
    "redirected": false,
    "url": "https://www.cipherguard.test/settings.json?api-version=v2",
    "ok": true,
  }
));
