...
- PB-35182: WP2-3.1 Migrate the resource types event 'cipherguard.resource-type.get-all' into a controller
...
- PB-33426 As a user I should see the cipherguard icon turns gray on a fresh start from chrome MV3
...
## [4.7.0] - 2024-04-26
### Added
- PB-32931 As administrator, I see SSO and Directory Sync health checks in Cipherguard API Status page
...
- PB-22644 The cipherguard icon should detect if the user is still connected after the service worker awake
...
- PB-32291 Cleanup legacy code and unused cipherguard.auth.is-authenticated related elements
...
- PB-28842 As a user I can reach the Windows store cipherguard app from the Desktop app setup screen
...
- PB-26094 As an administrator having a cipherguard trespassing the user limits I should see a better message
...
- PB-25935 As a user registering to cipherguard I have to comply with the policy
...
- PB-25375 As a user I should not see the cipherguard icon on gmail email search
...
- PB-25339 Fix application refusing to load when detecting cipherguard event activities
- PB-25311 Fix as anonymous user with the browser extension not configured I should be redirected to cipherguard getting started page when using the toolbar icon
...
- PB-23541 As a user I can use SSO recover when Cipherguard is served from a subfolder
...
- PB-21393 As a registered user I can use the SSO feature to sign in to cipherguard
...
- PB-19793 As a user I want to see a consistent layout while signing-in to cipherguard
...
- PB-21443 As a user on the administration section I would like to see the cipherguard logo
- PB-21476 As signed-in user, I want to copy content in my clipboard using cipherguard over http
- PB-22022 Fix height for the svg Cipherguard logo
...
### Security
- PB-19537: As a user I want my password fields to be hidden in Cipherguard forms when the form is being submitted
...
- PB-16925 As AN I can access the sign in form of my organization from cipherguard.com
- PB-17094 Mark account recovery feature as stable
- PB-17095 As a user I can use cipherguard in Spanish
- PB-17095 As a user I can use cipherguard in Lituanian
...
- PB-15247 As a user I should not see cipherguard setup/recover starting on pages having similar urls
...
## [3.5.0] - 2021-01-12
### Added
- PB-13161 As LU I should be able to cipherguard with my Android mobile
- PB-13161 As LU I should be able to cipherguard with my IOS mobile
...
- PB-9748 Optimize in-form menu integration performance by avoiding the CTA mutation observer to be called when cipherguard manipulates the DOM itself
...
- PB-9331 Fix as LU I should not see the in-form menu CTA on the cipherguard trusted domain
...
- PB-7606 As LU I should be able to see how many credentials are suggested for the page I’m currently on by looking at the cipherguard icon in the toolbar
...
- PB-8492 Optimize cipherguard-styleguide dependency package size
...
- PB-7563 Update cipherguard styleguide dependencies

## [3.2.2] - 2021-05-31
### Fixed
- PB-7569 As AN with an unconfigured extension on chrome I should not get an error clicking on the toolbar cipherguard icon
...
- GITHUB-238: As an administrator I should be able to install cipherguard on a domain without a TLD.
...
- Fix the response to the event 'cipherguard.share.get-folders' should return an array
...
- PB-449: Fix auth redirect when cipherguard is installed in directory
...
## [2.7.0] - 2019-02-08
### Improvement
- CIPHERGUARD-3347: When the extension requires the users to enter their master password, the popup should be displayed with no delay
- CIPHERGUARD-3313: As GM adding a user to a group I should see the loading popup when the extension is processing/requesting the API
- CIPHERGUARD-3312: As GM adding a user to a group I should see a relevant feedback in case of network/proxy errors
- CIPHERGUARD-3316: As LU Sharing a password I should see a loading feedback when the extension is requesting the API
...
## [2.4.5] - 2018-12-04
### Fix
- CIPHERGUARD-3256: Fix the bulk share passwords feature which could have forgot passwords when a user is sharing more than 100 passwords
...
### Improved
- CIPHERGUARD-2981: As Pro LU importing a large set of passwords I should request the API by batch
- CIPHERGUARD-3074: As a logged in user selecting a "remember me" duration the  checkbox should be selected automatically

### Fix
- CIPHERGUARD-3022: Fix the "import tag" is not associated to passwords imported from a csv where have no category

## [2.2.1] - 2018-08-14
### Fix
- Fix login redirect issue, it should not redirect to / if cipherguard is installed in a subfolder

## [2.2.0] - 2018-08-13
### Fix
- Fix setup fatal error should not trigger a redirect
- CIPHERGUARD-2940 AppPagemod should start on the routes of the appjs /app/*
...
- CIPHERGUARD-2854 [Pro] Fix bug tags imported are always the same
- CIPHERGUARD-2887 [Pro] Fix iframe resize issue
...
## [2.0.5] - 2018-05-08
### Fix
- CIPHERGUARD-2857: Fix password generator does not use secure PRNG
- GITHUB-35: Fix login redirects in wrong tab
- CIPHERGUARD-2764: Fix share autocomplete search concurrency issue on result display

### Improve
- CIPHERGUARD-2853: Upgrade to OpenPGP.js 3.x
- CIPHERGUARD-2853: Improve error feedback on login
- CIPHERGUARD-2853: Cleanup config defaults

## [1.6.10] - 2018-03-28
### Fixed
- CIPHERGUARD-2774: Fix download in chrome 65
- CIPHERGUARD-2777: Manage third party libraries with npm
- CIPHERGUARD-2709: [Pro] As LU I can use the remember me feature on the login form
- CIPHERGUARD-2707: [Pro] As LU I can choose the duration cipherguard remember my passphrase in a set of options
- CIPHERGUARD-2648: [Pro] As LU I can import passwords from kdbx or csv
- CIPHERGUARD-2655: [Pro] As LU I can export my passwords in kdbx or csv
...
- CIPHERGUARD-2677: Add version number to all API calls
- CIPHERGUARD-2677: Fix recover link is wrong when optional redirect parameter is set in url
- CIPHERGUARD-2677: Bump dependencies to higher versions

## [1.6.8] - 2017-12-28
### Fixed
- CIPHERGUARD-2558: Security fix content scripts should not be injected on non trusted domain
- CIPHERGUARD-2558: Wordsmith verify feature help text
- CIPHERGUARD-2199: Drop jpm from list of dependencies
- CIPHERGUARD-2199: Fix key import key info screen control flow
- CIPHERGUARD-2199: Fix register link
- CIPHERGUARD-2199: Add alternative Gpgkey key property armored_key prior to API v2 rollout
- CIPHERGUARD-2474: Add new github contribution guidelines and issue templates

## [1.6.7] - 2017-10-13
### Fixed
- CIPHERGUARD-2452: Fix broken template on stage0 missing server key
- CIPHERGUARD-2455: Fix setup should not use browser storage to temporarily store private key

## [1.6.6] - 2017-10-02
### Fixed
- CIPHERGUARD-2419: Remove FF legacy extension support
- CIPHERGUARD-2423: Template missing when recovering an account: setup/importKeyRecoverInfo.ejs
- CIPHERGUARD-2425: Chrome 61, issue with minified version of jquery

## [1.6.5] - 2017-09-14
### Fixed
- CIPHERGUARD-2386: Enforce the usage of templates instead of manual DOM content insertion

## [1.6.4] - 2017-08-31
### Fixed
- CIPHERGUARD-2344: Remove content scripts from web accessible resources
- CIPHERGUARD-2352: Webextension should not use defer(), use native promise instead
- CIPHERGUARD-2350: Move grunt-cipherguard-ejs-template-compile as node module
- CIPHERGUARD-2370: Plugin upgrade openpgpjs to 2.5.10

## [1.6.3] - 2017-08-21
### Fixed
- CIPHERGUARD-2318: Remove unsafe-eval from CSP
- CIPHERGUARD-2318: Precompile EJS templates using grunt-cipherguard-ejs-compile task
- CIPHERGUARD-2269: As LU I can't encrypt a secret for more than 200 people #GITHUB-124
- CIPHERGUARD-2346: Plugin upgrade openpgpjs to 2.5.9

## [1.6.2] - 2017-08-12
### Added
- CIPHERGUARD-2198: Migrate from Firefox legacy SDK to embed/native webextensions
- CIPHERGUARD-2254: Add log system to grab selenium tests traces
- CIPHERGUARD-2210: Update Grunt build tasks
- CIPHERGUARD-2200: Update to OpenPGP.js version 2.5.8
- CIPHERGUARD-2069: Update to JQuery version 3.2.1
- CIPHERGUARD-2248: Migrate from window.localStorage to chrome.storage on chrome
- CIPHERGUARD-2283: Migrate from simplestorage to chrome.storage on firefox
...
## [1.5.1] - 2017-05-23
### Fixed
- CIPHERGUARD-1908: Fix memory leak with openpgp webworker initialization

## [1.5.0] - 2017-05-16
### Added
- CIPHERGUARD-1955: As an administrator I can create a group
- CIPHERGUARD-1969: As a group manager I can see which users are part of a given group from the group edit dialog
- CIPHERGUARD-1838: As a group manager I can add a user to a group using the edit group dialog
- CIPHERGUARD-1838: As a group manager adding a user to a group, the passwords the group has access should be encrypted for the new user
- CIPHERGUARD-1838: As a group manager I can remove a user from a group using the edit group dialog
- CIPHERGUARD-1969: As a group manager I can edit the membership roles
...
### Fixed
- CIPHERGUARD-2031: Share a password with multiple users/groups in a single operation

## [1.4.3] - 2017-02-16
### Updated
- CIPHERGUARD-1909: updated openpgpjs to latest version: 1.3.7. Thanks to @pomarec for the pull request. (https://github.com/cipherguard/cipherguard_browser_extension/pull/11)

## [1.4.2] - 2017-02-11
### Fixed
- Fix for chrome 56 memory leak (https://www.cipherguard.com/incidents/20170210_chrome_not_available)

## [1.4.0] - 2017-02-07
### Fixed
- CIPHERGUARD-1850: GITHUB-5 Minor spelling and grammar fixes (@colin-campbell)
- CIPHERGUARD-1807: Fix parsing issues with keys that have multiple identities

## [1.3.2] - 2017-01-16
### Fixed
- CIPHERGUARD-1827: As a user I should be able to log in with a passphrase longer than 50 chars in length
- CIPHERGUARD-1809: As a developer I should be able to get the chrome zip distrib file as part of the build process

## [1.3.1] - 2017-01-03
### Fixed
- CIPHERGUARD-1606: Wrong message when auto logged out and cipherguard is not the active tab
- CIPHERGUARD-1769: Refactor extension bootstrap, prepare code to welcome future features
- CIPHERGUARD-1759: Share: autocomplete list will appear even when there is no text entered in the search
- CIPHERGUARD-1760: Share: image is broken in the autcomplete list after user has changed it
- CIPHERGUARD-1566: Share autocomplete html is not valid
- CIPHERGUARD-1778: Simplify toolbarController openCipherguardTab function
- CIPHERGUARD-1680: Password is limited to 50 chars, increase the limit to 4096
- CIPHERGUARD-1657: As AP I should not be able to complete the recovery process with my public key

## [1.3.0]
### Added - 2016-11-25
- CIPHERGUARD-1725: Chrome support

### Fixed
- CIPHERGUARD-1708: Refactor Request get and post to use fetch

## [1.2.0] - 2016-10-16
### Fixed
- CIPHERGUARD-1668: Refactor GPGAuth to handle capitalization issue. See github #24 & #16
- CIPHERGUARD-1660: Refactoring ground work for Chrome Extension
- CIPHERGUARD-1698: Gpgkey is not downloadable after generation

## [1.1.1] - 2016-08-13
### Fixed
- CIPHERGUARD-1655: Visual glitch on password create field, bump to styleguide v1.1.0
- CIPHERGUARD-1635: Clean/Document messaging layer

## [1.1.0] - 2016-08-09
### Fixed
- CIPHERGUARD-1432: Cipherguard.app pagemod shouldn't start if user is not logged in
...
## [1.0.12] - 2016-05-31
### Added
- CIPHERGUARD-959: Added plugin version number in footer.
- CIPHERGUARD-1488: As AP, I shouldn't be able to complete the setup if I import a key that already exist on server.

### Fixed
- CIPHERGUARD-1255: Button height issues + missing tooltip on setup

## [1.0.11] - 2016-16-16
### Added
- CIPHERGUARD-1108: As LU when entering my master key I can have the plugin remember it for 5 min.

### Fixed
- CIPHERGUARD-1494: After two consecutive setup, the plugin stops working and doesn't start anymore.

## [1.0.10] - 2016-05-03
### Changed
- CIPHERGUARD-1316: As a AP trying to register again, I should see an information message informing me that the plugin is already configured.
...
## [1.0.9-a] - 2016-04-15
### Fixed
- CIPHERGUARD-1408: As a LU I should see the email addresses of the people I'm sharing a password with.

## [1.0.8] - 2016-04-05
### Fixed
- CIPHERGUARD-1455: As a AP during setup I should not see Learn more broken links.
- CIPHERGUARD-1158: Cleanup: remove useless console.log() from the code.

## [1.0.7] - 2016-04-04
### Fixed
- CIPHERGUARD-1158: Cleanup: remove useless console.log() from the code.
- CIPHERGUARD-1462: Remove spelling mistake on encrypting.

## [1.0.6] - 2016-03-28
### Fixed
- CIPHERGUARD-1424: Cleanup: in Firefox addon remove URL_PLUBLIC_REGISTRATION.
- CIPHERGUARD-1417: At the end of the setup, or in case of setup fatal error, setup data should be cleared.
- CIPHERGUARD-1359: Setup should restart where it was left.


## [1.0.5] - 2016-03-21
### Added
- CIPHERGUARD-1304: As a LU getting an Error500 when trying to authenticate I should see a retry button.
- CIPHERGUARD-1310: As user whose account is deleted I should get an appropriate feedback on login.

### Fixed
- CIPHERGUARD-1377: As LU I should be able to login again after my session timed out.
- CIPHERGUARD-1381: As LU I should not be able to share a password with a user who is registered but who has not completed his setup
- CIPHERGUARD-1418: The App worker should be attached only on private pages.
...
[Unreleased]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v4.10.2...HEAD
[4.10.2]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v4.10.0...v4.10.2
[4.10.0]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v4.9.4...v4.10.0
[4.9.4]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v4.9.3...v4.9.4
[4.9.3]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v4.9.2...v4.9.3
[4.9.2]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v4.9.1...4.9.2
[4.9.1]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v4.9.0...4.9.1
[4.9.0]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v4.8.2...4.9.0
[4.8.2]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v4.8.1...4.8.2
[4.8.1]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v4.8.0...4.8.1
[4.8.0]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v4.7.8...4.8.0
[4.7.8]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v4.7.7...v4.7.8
[4.7.7]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v4.7.6...v4.7.7
[4.7.6]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v4.7.5...v4.7.6
[4.7.5]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v4.7.4...v4.7.5
[4.7.4]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v4.7.3...v4.7.4
[4.7.3]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v4.7.1...v4.7.3
[4.7.1]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v4.7.0...v4.7.1
[4.7.0]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v4.6.2...v4.7.0
[4.6.2]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v4.6.0...v4.6.2
[4.6.0]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v4.5.2...v4.6.0
[4.5.2]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v4.5.1...v.4.5.2
[4.5.1]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v4.5.0...v.4.5.1
[4.5.0]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v4.4.2...v.4.5.0
[4.4.2]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v4.4.0...v.4.4.2
[4.4.0]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v4.3.1...v.4.4.0
[4.3.1]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v4.3.0...v.4.3.1
[4.3.0]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v4.2.0...v.4.3.0
[4.2.0]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v4.1.2...v.4.2.0
[4.1.2]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v4.1.0...v4.1.2
[4.1.0]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v4.0.4...v4.1.0
[4.0.4]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v4.0.3...v4.0.4
[4.0.3]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v4.0.1...v4.0.3
[4.0.1]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v4.0.0...v4.0.1
[4.0.0]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v3.12.1...v4.0.0
[3.12.1]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v3.12.0...v3.12.1
[3.12.0]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v3.11.2...v3.12.0
[3.11.2]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v3.11.0...v3.11.2
[3.11.0]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v3.10.0...v3.11.0
[3.10.0]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v3.9.2...v3.10.0
[3.9.2]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v3.9.0...v3.9.2
[3.9.0]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v3.8.0...v3.9.0
[3.8.0]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v3.7.3...v3.8.0
[3.7.3]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v3.7.2...v3.7.3
[3.7.2]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v3.7.1...v3.7.2
[3.7.1]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v3.7.0...v3.7.1
[3.7.0]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v3.6.2...v3.7.0
[3.6.2]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v3.6.1...v3.6.2
[3.6.1]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v3.6.0...v3.6.1
[3.6.0]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v3.5.2...v3.6.0
[3.5.2]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v3.5.1...v3.5.2
[3.5.1]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v3.5.0...v3.5.1
[3.5.0]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v3.4.0...v3.5.0
[3.4.0]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v3.3.1...v3.4.0
[3.3.1]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v3.3.0...v3.3.1
[3.3.0]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v3.2.3...v3.3.0
[3.2.3]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v3.2.2...v3.2.3
[3.2.2]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v3.2.1...v3.2.2
[3.2.1]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v3.1.0...v3.2.1
[3.1.0]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v3.0.7...v3.1.0
[3.0.7]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v3.0.6...v3.0.7
[3.0.6]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v3.0.5...v3.0.6
[3.0.5]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v3.0.4...v3.0.5
[3.0.4]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v3.0.3...v3.0.4
[3.0.3]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v3.0.2...v3.0.3
[3.0.2]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v3.0.1...v3.0.2
[3.0.1]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v3.0.0...v3.0.1
[3.0.0]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v2.13.8...v3.0.0
[2.13.8]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v2.13.7...v2.13.8
[2.13.7]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v2.13.6...v2.13.7
[2.13.6]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v2.13.5...v2.13.6
[2.13.5]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v2.13.4...v2.13.5
[2.13.4]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v2.13.3...v2.13.4
[2.13.3]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v2.13.2...v2.13.3
[2.13.2]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v2.13.1...v2.13.2
[2.13.1]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v2.13.0...v2.13.1
[2.13.0]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v2.12.1...v2.13.0
[2.12.1]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v2.12.0...v2.12.1
[2.12.0]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v2.11.3...v2.12.0
[2.11.3]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v2.11.2...v2.11.3
[2.11.2]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v2.11.1...v2.11.2
[2.11.1]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v2.11.0...v2.11.1
[2.11.0]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v2.10.1...v2.11.0
[2.10.1]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v2.10.0...v2.10.1
[2.10.0]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v2.9.2...v2.10.0
[2.9.2]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v2.9.1...v2.9.2
[2.9.1]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v2.9.0...v2.9.1
[2.9.0]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v2.8.3...v2.9.0
[2.8.3]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v2.8.2...v2.8.3
[2.8.2]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v2.8.1...v2.8.2
[2.8.1]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v2.8.0...v2.8.1
[2.8.0]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v2.7.0...v2.8.0
[2.7.0]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v2.4.6...v2.7.0
[2.4.6]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v2.4.5...v2.4.6
[2.4.5]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v2.4.4...v2.4.5
[2.4.4]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v2.4.3...v2.4.4
[2.4.3]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v2.4.2...v2.4.3
[2.4.2]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v2.4.1...v2.4.2
[2.4.1]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v2.4.0...v2.4.1
[2.4.0]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v2.2.1...v2.4.0
[2.2.1]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v2.2.0...v2.2.1
[2.2.0]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v2.1.0...v2.2.0
[2.1.0]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v2.0.10...v2.1.0
[2.0.10]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v2.0.9...v2.0.10
[2.0.9]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v2.0.8...v2.0.9
[2.0.8]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v2.0.7...v2.0.8
[2.0.7]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v2.0.6...v2.0.7
[2.0.6]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v2.0.5...v2.0.6
[2.0.5]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v1.6.10...v2.0.5
[1.6.10]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v1.6.9...v1.6.10
[1.6.9]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v1.6.6...v1.6.9
[1.6.6]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v1.6.5...v1.6.6
[1.6.5]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v1.6.4...v1.6.5
[1.6.4]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v1.6.3...v1.6.4
[1.6.3]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v1.6.2...v1.6.3
[1.6.2]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v1.6.1...v1.6.2
[1.6.1]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v1.6.0...v1.6.1
[1.6.0]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v1.5.1...v1.6.0
[1.5.1]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v1.5.0...v1.5.1
[1.5.0]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v1.4.2...v1.5.0
[1.4.3]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v1.4.2...v1.4.3
[1.4.2]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v1.4.0...v1.4.2
[1.4.0]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v1.3.2...v1.4.0
[1.3.2]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v1.3.1...v1.3.2
[1.3.1]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v1.3.0...v1.3.1
[1.3.0]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v1.2.0...v1.3.0
[1.2.0]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v1.1.1...v1.2.0
[1.1.1]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v1.1.0...v1.1.1
[1.1.0]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v1.0.13...v1.1.0
[1.0.13]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v1.0.12...v1.0.13
[1.0.12]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v1.0.11...v1.0.12
[1.0.11]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v1.0.10...v1.0.11
[1.0.10]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v1.0.9-b...v1.0.10
[1.0.9-b]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v1.0.9-a...v1.0.9-b
[1.0.9]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v1.0.8...v1.0.9-a
[1.0.8]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v1.0.7...v1.0.8
[1.0.7]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v1.0.6...v1.0.7
[1.0.6]: https://github.com/cipherguard/cipherguard_browser_extension/compare/v1.0.5...v1.0.6
[1.0.5]: https://github.com/cipherguard/cipherguard_browser_extension/compare/1.0.4...v1.0.5
