...
module.exports = function (grunt) {
  ...
  const firefoxWebExtBuildName = 'cipherguard_-_open_source_password_manager';
    ...
    copy: {
      ...
      styleguide: {
        files: [{
          // Avatar
          nonull: true,
          cwd: path.node_modules + 'cipherguard-styleguide/src/img/avatar',
          ...
          // Controls
          nonull: true,
          cwd: path.node_modules + 'cipherguard-styleguide/src/img/controls',
          src: [
          ...
          // Icons / logo
          nonull: true,
          cwd: path.node_modules + 'cipherguard-styleguide/src/img/logo',
          src: [
          ...
          // Illustrations
          nonull: true,
          cwd: path.node_modules + 'cipherguard-styleguide/src/img/illustrations',
          src: ['passphrase_intro.svg', 'pin_cipherguard.gif', 'wave-pin_my_extension.svg', 'email.png'],
          dest: path.build_web_accessible_resources + 'img/illustrations',
          expand: true
        }, {
          // Third party logos
          nonull: true,
          cwd: path.node_modules + 'cipherguard-styleguide/src/img/third_party',
          ...
          nonull: true,
          cwd: path.node_modules + 'cipherguard-styleguide/src/img/themes',
          src: ['default.png', 'midgar.png', 'solarized_dark.png', 'solarized_light.png'],
          dest: path.build_web_accessible_resources + 'img/themes',
          expand: true
        }, {
          // CSS files default
          cwd: path.node_modules + 'cipherguard-styleguide/build/css/themes/default',
          src: [
          ...
          // CSS files midgar
          cwd: path.node_modules + 'cipherguard-styleguide/build/css/themes/midgar',
          src: [
          ...
          cwd: path.node_modules + 'cipherguard-styleguide/build/css/themes/solarized_light',
          src: [
            'ext_login.min.css', 'ext_in_form_cta.min.css', 'ext_setup.min.css', 'ext_quickaccess.min.css',
            'ext_app.min.css', 'ext_authentication.min.css', 'ext_in_form_menu.min.css'
          ],
          ...
          cwd: path.node_modules + 'cipherguard-styleguide/build/css/themes/solarized_dark',
          src: [
            'ext_login.min.css', 'ext_in_form_cta.min.css', 'ext_setup.min.css', 'ext_quickaccess.min.css',
            'ext_app.min.css', 'ext_authentication.min.css', 'ext_in_form_menu.min.css'
          ],
          ...
          // Fonts
          cwd: path.node_modules + 'cipherguard-styleguide/src/fonts',
          src: ['opensans-bold.woff', 'opensans-regular.woff', 'cipherguard.ttf', 'inconsolata-regular.ttf'],
          dest: path.build_web_accessible_resources + 'fonts',
          expand: true
        }, {
          // Locales
          cwd: path.node_modules + 'cipherguard-styleguide/src/locales',
          src: ['**'],
    ...
    shell: {
      ...
      build_firefox_debug: {
        ...
        command: [
          ...
          'mv ' + path.dist_firefox + firefoxWebExtBuildName + '-' + manifestVersion + '.zip ' + path.dist_firefox + 'cipherguard-' + pkg.version + '-debug.zip',
          'rm -f ' + path.dist_firefox + 'cipherguard-latest@cipherguard.com.zip',
          'ln -fs cipherguard-' + pkg.version + '-debug.zip ' + path.dist_firefox + 'cipherguard-latest@cipherguard.com.zip',
          "echo '\nMoved to " + path.dist_firefox + "cipherguard-" + pkg.version + "-debug.zip'"
        ].join(' && ')
      },
      build_firefox_prod: {
        options: {
        ...
        command: [
          './node_modules/.bin/web-ext build -s=' + path.build + ' -a=' + path.dist_firefox + '  -o=true',
          'mv ' + path.dist_firefox + firefoxWebExtBuildName + '-' + manifestVersion + '.zip ' + path.dist_firefox + '/cipherguard-' + pkg.version + '.zip',
          "echo '\nMoved to " + path.dist_firefox + "cipherguard-" + pkg.version + ".zip'"
        ].join(' && ')
      },
      ...
      build_chrome_debug: {
        ...
        command: [
          './node_modules/.bin/crx pack ' + path.build + ' -p key.pem -o ' + path.dist_chrome + 'cipherguard-' + pkg.version + '-debug.crx',
          'rm -f ' + path.dist_chrome + 'cipherguard-latest@cipherguard.com.crx',
          'ln -fs cipherguard-' + pkg.version + '-debug.crx ' + path.dist_chrome + 'cipherguard-latest@cipherguard.com.crx'
        ].join(' && ')
      },
      build_chrome_prod: {
        options: {
        ...
        command: [
          'zip -q -1 -r ' + path.dist_chrome + 'cipherguard-' + pkg.version + '.zip ' + path.build,
          './node_modules/.bin/crx pack ' + path.build + ' -p key.pem -o ' + path.dist_chrome + 'cipherguard-' + pkg.version + '.crx ',
      ...
      build_chrome_mv3_debug: {
        ...
        command: [
          './node_modules/.bin/crx pack ' + path.build + ' -p key.pem -o ' + path.dist_chrome_mv3 + 'cipherguard-' + pkg.version + '-debug.crx',
          'rm -f ' + path.dist_chrome_mv3 + 'cipherguard-latest@cipherguard.com.crx',
          'ln -fs cipherguard-' + pkg.version + '-debug.crx ' + path.dist_chrome_mv3 + 'cipherguard-latest@cipherguard.com.crx'
        ].join(' && ')
      },
      build_chrome_mv3_prod: {
        ...
        command: [
          'zip -q -1 -r ' + path.dist_chrome_mv3 + 'cipherguard-' + pkg.version + '.zip ' + path.build,
          './node_modules/.bin/crx pack ' + path.build + ' -p key.pem -o ' + path.dist_chrome_mv3 + 'cipherguard-' + pkg.version + '.crx ',
